  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <textarea rows={4} value={input} onChange={(e) => setInput(e.target.value)} placeholder="Describe what you want to see in the image.." required className="w-full mt-2 p-3 text-sm rounded-md border border-gray-300 outline-none focus:ring-2 focus:ring-green-400" />
        ...
        <div className="mt-3 flex gap-3 flex-wrap">
          ...
          {ImageStyle.map((item) => (
            <span
              ...
              className={`px-4 py-1.5 text-xs rounded-full border cursor-pointer transition
                ${
                  selectedStyle === item
